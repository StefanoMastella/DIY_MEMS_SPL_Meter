...
os.chdir(cwd+'\Bkgn 01') # Chose the folder you want to analyse, ex: (cwd+'\folder_name')
...
plt.title(r'Níveis de Pressão Sonora em oitavas com três ponderações diferentes')
...
# Save figure
plt.savefig('Nível em oitavas ponto 1.png', dpi=600)
plt.show()
